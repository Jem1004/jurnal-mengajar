...
- [x] 2. Setup PostgreSQL dengan Docker untuk development
...
- [x] 3. Setup Prisma ORM dan database schema
  - [x] 3.1 Buat Prisma schema dengan semua models
  ...
  - [x] 3.2 Generate Prisma Client dan jalankan migrasi
  ...
  - [x] 3.3 Buat Prisma client singleton
...
- [x] 4. Implementasi authentication dengan NextAuth
  - [x] 4.1 Konfigurasi NextAuth dengan Credentials Provider
  ...
  - [x] 4.2 Buat API route handler untuk NextAuth
    - Buat file `/app/api/auth/[...nextauth]/route.ts`
    - Export GET dan POST handlers dengan authOptions
    - _Requirements: 1.1, 1.2, 1.3_
  
  - [x] 4.3 Implementasi middleware untuk route protection
...
- [x] 5. Buat reusable UI components dengan Tailwind
...
- [x] 6. Implementasi service layer untuk business logic
  - [x] 6.1 Buat Master Data Service
  ...
  - [x] 6.4 Buat Admin Service untuk reports
...
- [x] 7. Implementasi Server Actions untuk data operations
  - [x] 7.1 Buat Server Actions untuk Jurnal
  ...
  - [x] 7.2 Buat Server Actions untuk Master Data
  ...
  - [x] 7.3 Buat Server Actions untuk Analytics
...
- [x] 8. Implementasi Dashboard Guru
  - [x] 8.1 Buat halaman Dashboard Guru
  ...
  - [x] 8.2 Buat komponen Jadwal Card
...
- [x] 9. Implementasi Form Jurnal Mengajar
  - [x] 9.1 Buat halaman Form Jurnal
  ...
  - [x] 9.4 Implementasi Smart Checklist Absensi
  ...
  - [x] 9.5 Implementasi Bagian Catatan & Tindak Lanjut
  ...
  - [x] 9.6 Implementasi Modal Tag Siswa
  ...
  - [x] 9.7 Implementasi submit form dan save jurnal
...
- [x] 10. Implementasi Halaman Analitik Personal Guru
  - [x] 10.1 Buat halaman Analitik Personal
  ...
  - [x] 10.2 Implementasi Card Keterlaksanaan TP
  ...
  - [x] 10.3 Implementasi Card Analitik Absensi Siswa
  ...
  - [x] 10.4 Implementasi Card Analitik Tindak Lanjut
...
- [ ] 11. Implementasi Dashboard Admin
  - [x] 11.1 Buat halaman Dashboard Admin
  ...
  - [x] 11.2 Buat halaman Laporan Keterisian Jurnal
  ...
  - [x] 11.3 Buat halaman Laporan Agregat Absensi
...
- [x] 12. Implementasi CRUD Master Data untuk Admin
  - [x] 12.1 Buat halaman Management Guru
  ...
  - [x] 12.2 Buat halaman Management Kelas
  ...
  - [x] 12.5 Buat halaman Management Jadwal
...
- [x] 13. Implementasi seeding data untuk development
...
- [x] 14. Implementasi error handling dan validation
  - [x] 14.1 Buat custom error classes
  ...
  - [x] 14.2 Buat Zod schemas untuk validation
  ...
  - [x] 14.3 Implementasi error boundary
...
- [x] 15. Polish UI/UX dan responsive design
...
- [x] 17. Documentation dan deployment preparation
